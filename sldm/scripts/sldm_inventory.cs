package sldm_inventory
{


function ShocklanceDMGame::initInventory()
{
	// Never allow these in player inventory
	$InvBanList[ShocklanceDM, "TurretOutdoorDeployable"] = 1;
	$InvBanList[ShocklanceDM, "TurretIndoorDeployable"] = 1;
	$InvBanList[ShocklanceDM, "ElfBarrelPack"] = 1;
	$InvBanList[ShocklanceDM, "MortarBarrelPack"] = 1;
	$InvBanList[ShocklanceDM, "PlasmaBarrelPack"] = 1;
	$InvBanList[ShocklanceDM, "AABarrelPack"] = 1;
	$InvBanList[ShocklanceDM, "MissileBarrelPack"] = 1;
	$InvBanList[ShocklanceDM, "ShieldPack"] = 1;
	$InvBanList[ShocklanceDM, "AmmoPack"] = 1;
	$InvBanList[ShocklanceDM, "CloakingPack"] = 1;
	$InvBanList[ShocklanceDM, "RepairPack"] = 1;
	$InvBanList[ShocklanceDM, "Mine"] = 1;
	$InvBanList[ShocklanceDM, "Blaster"] = 1;
	$InvBanList[ShocklanceDM, "Mortar"] = 1;
	$InvBanList[ShocklanceDM, "Disc"] = 1;
	$InvBanList[ShocklanceDM, "Chaingun"] = 1;
	$InvBanList[ShocklanceDM, "MissileLauncher"] = 1;
	$InvBanList[ShocklanceDM, "GrenadeLauncher"] = 1;
	$InvBanList[ShocklanceDM, "SniperRifle"] = 1;
	$InvBanList[ShocklanceDM, "ELFGun"] = 1;
	$InvBanList[ShocklanceDM, "Plasma"] = 1;
	$InvBanList[ShocklanceDM, "CameraGrenade"] = 1;
	$InvBanList[ShocklanceDM, "MotionSensorDeployable"] = 1;
	$InvBanList[ShocklanceDM, "PulseSensorDeployable"] = 1;
	$InvBanList[ShocklanceDM, "SatchelCharge"] = 1;
	$InvBanList[ShocklanceDM, "SensorJammerPack"] = 1;
	$InvBanList[ShocklanceDM, "InventoryDeployable"] = 1;
	$InvBanList[ShocklanceDM, "Beacon"] = 1;
}

function ShocklanceDMGame::equip(%game, %player)
{
...
function InventoryScreen::updateHud(%this, %client, %tag)
{
	...
	if ( %favorite $= empty ||
	     %favorite $= invalid ||
	    (%favorite $= "Whiteout Grenade" && $ShocklanceDM::Pref::AllowWhiteoutGrenades < 4) ||
	    (%favorite $= "Concussion Grenade" && $ShocklanceDM::Pref::AllowConcussionGrenades < 4) ||
	    (%favorite $= "Grenade" && $ShocklanceDM::Pref::AllowNormalGrenades < 4) ||
	...
	if (%favorite !$= "Whiteout Grenade" && $ShocklanceDM::Pref::AllowWhiteoutGrenades > 3)
		%list = %list TAB "Whiteout Grenade";

	if (%favorite !$= "Concussion Grenade" && $ShocklanceDM::Pref::AllowConcussionGrenades > 3)
		%list = %list TAB "Concussion Grenade";

	if (%favorite !$= "Grenade" && $ShocklanceDM::Pref::AllowNormalGrenades > 3)
		%list = %list TAB "Grenade";
...
function stationTrigger::onEnterTrigger(%data, %obj, %colObj)
{
	...
	if (Game.stationOnEnterTrigger(%data, %obj, %colObj))
	{
		...
		else if ($ShocklanceDM::Pref::InventoryStationTeleportation > 3)
		{
			// check for penalty
		...
		else if ($ShocklanceDM::Pref::InventoryStationAccess < 4)
		{
...
function ShocklanceDMGame::inventoryPenalty(%game, %obj)
{
...
function ShocklanceDMGame::stationOnEnterTrigger(%game, %data, %obj, %colObj)
{
...
function buyFavorites(%client)
{
	...
	// miscellaneous stuff -- Repair Kit, Targeting Laser
